...
TARGET_LOG_FILE=/var/log/imvi.log
...
SED_RULE_6 = 's,++IMVI_PATH++,$(TARGET_EXECUTABLE),g'
...
SED_RULE_10 = 's,++TARGET_LOGFILE++,$(TARGET_LOG_FILE),g'
SED_RULE_11 = 's,++TARGET_ENTRY++,$(TARGET_PATH_PYTHON)/$(SOURCE_ENTRY_POINT),g'
$(TARGET_OVERLAY_BIN): $(SOURCE_EXECUTABLE)
	mkdir -p $(dir $@)
	sed -e $(SED_RULE_10) -e $(SED_RULE_11) $< >$@
	chmod a+x $@
